...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, Category = Game, Meta = (DisplayName = "OnGameStageLevelCpp"))
	void K2_OnStageLevel(int32 NewStageLevel);

	void GameScoreChanged(int32 NewScore);
	void GameClear();
	void GameOver();
	void GameStageLevelChanged(int32 NewStageLevel);
